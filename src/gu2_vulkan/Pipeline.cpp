...
void Pipeline::createGraphicsPipeline()
{
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float)_settings.swapChainExtent.width;
    viewport.height = (float)_settings.swapChainExtent.height;
    viewport.minDepth = 0.0f;
    viewport.maxDepth = 1.0f;

    VkRect2D scissor{};
    scissor.offset = {0, 0};
    scissor.extent = _settings.swapChainExtent;
    ...
    for (uint32_t i=0; i<_settings.colorAttachmentCount; ++i) {
    ...
    colorBlending.attachmentCount = _settings.colorAttachmentCount;
    ...
    if (vkCreatePipelineLayout(_settings.device, &pipelineLayoutInfo, nullptr, &_pipelineLayout) != VK_SUCCESS)
    ...
    pipelineInfo.renderPass = _settings.renderPass;
